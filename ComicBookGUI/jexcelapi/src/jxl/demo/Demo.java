...
public class Demo
{
  ...
  public static void main(String args[])
  {
    ...
    {
      logger.debug("A ComicGUI \"debug\" message");
      logger.info("A ComicGUI \"info\" message");
      logger.warn("A ComicGUI \"warning\" message");
      logger.error("A ComicGUI \"error\" message");
      logger.fatal("A ComicGUI \"fatal\" message");
      System.exit(0);
    }
